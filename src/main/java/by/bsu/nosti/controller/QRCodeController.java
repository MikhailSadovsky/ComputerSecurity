...
public class QRCodeController extends BaseController {
	...
	public void postGenerateQRCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	public String verify(@RequestParam("code") String codestr, @RequestParam("username") String username,
